...
//   const ambush = await products.addProd("ambush", "One of the pants I never heard", "pants", "66", "39");
...
async function test(){
   ...
   //const airmax = await products.getProdById("22baa54e-3148-4dff-a6f1-5890441c26cb");
   // console.log(airmax);
    //const newUser = await users.addCartToUser("587642e9-6267-4b27-b9cf-cf43437c971e", "4026aaa1-3df9-4998-9cfb-322f94e3cf78");
    const newUser = await userCart.addItemToCart("587642e9-6267-4b27-b9cf-cf43437c971e", "4026aaa1-3df9-4998-9cfb-322f94e3cf78");
    await wish.addItemToWish("587642e9-6267-4b27-b9cf-cf43437c971e", "4026aaa1-3df9-4998-9cfb-322f94e3cf78");
    // const airmax =  await users.getUserByEmail("125@abc.com");
    // if(airmax!=null){console.log("ok")}
    // else{
    //     console.log("2")
    // }
    console.log("2")
